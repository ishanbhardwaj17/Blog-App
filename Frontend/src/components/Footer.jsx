...
const Footer = ({
  ...
  copyrightText = "Your Blog App. All rights reserved.",
  barCount = 40, // Increased slightly to fill width better
}) => {
  ...
  return (
    ...
    >
      {/* ================= LINKS ================= */}
      <div className="container mx-auto flex flex-col md:flex-row justify-between w-full gap-4 pb-20 pt-12 px-4">
